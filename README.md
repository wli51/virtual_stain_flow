...
Below is an example showcasing the input, target, and prediction generated by the Virtual Stain Flow framework using the ConvNeXt-UNet model. This model, inspired by [Cytoland](https://doi.org/10.1038/s42256-025-01046-2), predicts CellPainting DNA (Hoechst 33342) from cell painting assay in the U2-OS cell line based on brightfield microscopy images:
